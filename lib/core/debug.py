# -*- coding: utf-8 -*-
from lib.clasetting import delText
...
class Debug():
    ...
    def CreateFrm(self):
        ...
        with open('./lib/log/debug.log', mode='r', encoding='utf-8', errors='ignore') as f:
            array = f.readlines()
            # 遍历array中的每个元素
            for i in array:
    ...
    def save(self):
        ...
        with open('./lib/log/debug.log', mode='w', encoding='utf-8', errors='ignore') as f:
            f.write(save_data)
