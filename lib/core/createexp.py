# -*- coding: utf-8 -*-
from lib.settings import Ent_C_Top_vulname,Ent_C_Top_cmsname,Ent_C_Top_cvename,Ent_C_Top_version,Ent_C_Top_info,Ent_C_Top_template, \
...
from tkinter import W,X,Y,INSERT,BOTH,RIGHT,TOP,BOTTOM
...
class CreateExp():
    ...
    def Creat_from_temp(self):
        ...
        try:
            ...
            env = Environment(loader=PackageLoader('template', './lib'))
    ...
    def SelectTemplate(self,event):
        self.Template_name = './lib/template/'+self.comboxlist_B.get()+'.j2'
        self.text_B.delete('1.0','end')
        try:
