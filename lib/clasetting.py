...
class Ceye(object):
    def __init__(self):
        ...
        self.token = GlobalVar.get_value('CEYE_API')
        self.username = GlobalVar.get_value('CEYE_USERNAME')
        self.password = GlobalVar.get_value('CEYE_PASSWORD')
        self.check_account()
