    ...
    def HackingUrl_fromBaidu(Rulestr, page_count, timestr):
        ...
        for i in index:
            try:
                ...
                for div in divs:
                    try:
                        title = div.xpath("./h3[@class='c-title t t tts-title']//a/text()")[0]
                    except Exception:
                        title = 'null'
                    try:
