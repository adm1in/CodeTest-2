...
print("安装版：reg query HKEY_USERS\.DEFAULT\Software\Oray\SunLogin\SunloginClient\SunloginInfo")
print("绿色版：reg query HKEY_USERS\.DEFAULT\Software\Oray\SunLogin\SunloginClient\SunloginGreenInfo")
print("简约版：reg query HKEY_USERS\.DEFAULT\Software\Oray\SunLogin\SunloginClient\SunloginLiteInfo")
print("本机验证码参数：encry_pwd")
print("本机识别码参数：fastcode(去掉开头字母)")
print("判断用户是否登录状态：sunlogincode")
def check(**kwargs):
    encry_pwd = kwargs['url']
    sunlogincode = ''
    print("解密成功: "+Decrypt(base64.b64decode(encry_pwd),Init(KeyBlock.new_block(sunlogincode)).start()).start().decode())