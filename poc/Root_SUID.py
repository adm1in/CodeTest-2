...
print('[*](1)输入命令查看root用户拥有的SUID文件: \nfind / -user root -perm -4000 -print 2>/dev/null\nfind / -perm -u=s -type f 2>/dev/null\n(2)用grep查找有密码的文件: grep --color=auto --include=\'*.php\' -rnw \'/home/www/api\' -ie "PASSWORD" --color=always 2> /dev/null\n(3)查找敏感文件: locate password | more\n(4)查看用户最后编辑的文件: find / -mmin -10 2>/dev/null | grep -Ev "^/proc"\n(5)内核提权搜索脚本: https://github.com/mzet-/linux-exploit-suggester\n(6)计划任务:\ncat /etc/crontab\nls -ld /etc/cron.d/*\nls -ld /etc/cron*\ncat /var/spool/cron/crontabs/root\ncat /var/spool/cron/root\n(7)内核提权:\nhttp://127.0.0.1:8080/cve-2016-8655/cve-2016-8655.sh\nhttp://127.0.0.1:8080/cve-2016-9793/cve-2016-9793.sh\nhttp://127.0.0.1:8080/cve-2017-1000112/cve-2017-1000112.sh\nhttp://127.0.0.1:8080/cve-2017-7308/cve-2017-7308.sh\nhttp://127.0.0.1:8080/cve-2018-5333/cve-2018-5333.sh\nhttp://127.0.0.1:8080/cve-2019-13272/cve-2019-13272.sh\nhttp://127.0.0.1:8080/cve-2021-22555/cve-2021-22555.sh\nhttp://127.0.0.1:8080/cve-2021-4034/cve-2021-4034.sh\nhttp://127.0.0.1:8080/cve-2022-0847/cve-2022-0847.sh')
def check(**kwargs):
    flag = 0
    #分割后去空处理
