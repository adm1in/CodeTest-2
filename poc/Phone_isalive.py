...
def spider(urls,mphone):
    ...
    try:
        req = requests.post(urls, data=data, headers=headers, timeout=2, allow_redirects=False, verify=False)
...
if __name__ == "__main__":
    a = spider('https://account.chsi.com.cn/account/checkmobilephoneother.action','13888888888')
    print(a)