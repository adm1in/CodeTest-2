from lib.clasetting import ysoserial_payload,Ceye
...
class shiro():
    ...
    def cve_2016_4437(self):
        ...
        rulesRegex = re.compile('(=deleteMe|rememberMe=)')
        # print(type(str(r.headers)))
        resHeads = re.findall(rulesRegex, str(r.headers))
        if len(resHeads) == 0:
