...
+-------------+----------------+--------------------------------------------------------------------------------------------------+
| cve         | cve_2021_26084 | [rce] app="ATLASSIAN-Confluence" <6.13.23,6.14.0 - 7.4.11,7.5.0 - 7.11.6,7.12.0 - 7.12.5,<7.13.0 |
| cve         | cve_2022_23131 | [sso] app="ZABBIX-监控系统" && body="saml" 5.4.0 - 5.4.8, 6.0.0alpha1                             |
| cve         | cve_2022_26134 | [sso] app="Log-In-Confluence" 1.3.0 - 7.18.1                                                     |
+-------------+----------------+--------------------------------------------------------------------------------------------------+
"""
class cve():
